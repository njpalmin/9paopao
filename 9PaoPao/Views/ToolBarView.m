...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [locationButton setImage:[UIImage imageNamed:@"friends.png"] forState:UIControlStateNormal];
        ...
        [photoButton setImage:[UIImage imageNamed:@"friends.png"] forState:UIControlStateNormal];
        ...
        [poundSignButton setImage:[UIImage imageNamed:@"friends.png"] forState:UIControlStateNormal];
        ...
        [followButton setImage:[UIImage imageNamed:@"friends.png"] forState:UIControlStateNormal];
        ...
        [emotionButton setImage:[UIImage imageNamed:@"friends.png"] forState:UIControlStateNormal];
