...
- (BOOL)prepareHeaderView
{
    ...
    mAttentionBtn = [[PaoPaoCommon getImageButtonWithName:@"search-alcohol-selected.png" highlightName:nil action:@selector(procAttentionBtn:) target:self] retain];
    mAttentionBtn.frame = CGRectMake(220, 10, SearchKindBtnWidth, SearchKindBtnHeight);
    [headerView addSubview:mAttentionBtn];
    
    mChatBtn = [[PaoPaoCommon getImageButtonWithName:@"search-place.png" highlightName:nil action:@selector(procChatBtn:) target:self] retain];
